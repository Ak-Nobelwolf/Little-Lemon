    ...
    return (
        <article className="about-us">
            ...
            <section className="double-image">
                <img className="about-1" src={Food3Image} alt="Little Lemon restaurant cuisine 1"></img>
                <img className="about-2" src={Food2Image} alt="Little Lemon restaurant cuisine 2"></img>
            </section>
    </article>
    );
}